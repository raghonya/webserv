...
# Decode URL encoding (replace + with spaces and %xx with their ASCII characters)
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            color: white;
            text-align: center;
            background-image: url('https://www.transparenttextures.com/patterns/starry-night.png'); /* Optional background */
